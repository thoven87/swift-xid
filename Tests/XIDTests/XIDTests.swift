...
struct XIDPerformanceTests {
    ...
    func generationPerformance() {
        ...
        #expect(timeElapsed < 1.0, "Should generate 10,000 XIDs in under 1 second")
    }
    ...
    func stringEncodingPerformance() {
        ...
        let timeElapsed = CFAbsoluteTimeGetCurrent() - startTime
        #expect(timeElapsed < 0.1, "Should encode 1,000 XIDs to strings in under 0.1 seconds")
    }
    ...
    func stringDecodingPerformance() throws {
        ...
        let timeElapsed = CFAbsoluteTimeGetCurrent() - startTime
        #expect(timeElapsed < 0.1, "Should decode 1,000 XID strings in under 0.1 seconds")
    }
}
